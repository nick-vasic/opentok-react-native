...
var _packageInfo = require("../generated/packageInfo.js");
...
const getLog = (apiKey, sessionId, action, connectionId) => {
  const body = {
    payload: {
      ...
      otrn_version: _packageInfo.OTRN_PACKAGE_INFO.version,
    ...
    source: _packageInfo.OTRN_PACKAGE_INFO.repositoryUrl
  };
  if (connectionId) {
